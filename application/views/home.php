                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                        <td>
                          <div class="flag">
                            <img src="<?php echo base_url(); ?>assets/js/img/US.png">
                          </div>
                        </td>
                        <td>USA</td>
                        <td class="text-right">
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img src="<?php echo base_url(); ?>assets/js/img/DE.png">
                          </div>
                        </td>
                        <td>Germany</td>
                        <td class="text-right">
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img src="<?php echo base_url(); ?>assets/js/img/AU.png">
                          </div>
                        </td>
                        <td>Australia</td>
                        <td class="text-right">
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img src="<?php echo base_url(); ?>assets/js/img/GB.png">
                          </div>
                        </td>
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img src="<?php echo base_url(); ?>assets/js/img/RO.png">
                          </div>
                        </td>
                        <td>Romania</td>
                        <td class="text-right">
                      ...
                      <tr>
                        <td>
                          <div class="flag">
                            <img src="<?php echo base_url(); ?>assets/js/img/BR.png">
                          </div>
                        </td>
                        <td>Brasil</td>
                        <td class="text-right">
                  ...
                  <table class="table table-shopping">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="img-container">
                            <img src="<?php echo base_url(); ?>assets/js/img/saint-laurent.jpg" alt="...">
                          </div>
                        </td>
                        <td class="td-name">
                      ...
                      <tr>
                        <td>
                          <div class="img-container">
                            <img src="<?php echo base_url(); ?>assets/js/img/balmain.jpg" alt="...">
                          </div>
                        </td>
                        <td class="td-name">
                      ...
                      <tr>
                        <td>
                          <div class="img-container">
                            <img src="<?php echo base_url(); ?>assets/js/img/prada.jpg" alt="...">
                          </div>
                        </td>
                        <td class="td-name">
