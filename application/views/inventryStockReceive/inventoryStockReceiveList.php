          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <a class="btn btn-primary pull-right" href="<?php echo base_url(); ?>InventryStockReceiveController/addStockReceive">Add Inventry Stock Receive</a>
                <h4 class="card-title">Inventory Stock Receive List</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tbl_stockReceiveList" class="table" style="width:100%">
...
$(document).ready(function() {
    ...
    var tbl_stockReceiveList = $('#tbl_stockReceiveList').DataTable(
      {
      ...
      "processing": false,
              ...
              "scrollX": true,
               ajax: {
                  url: "<?php echo base_url() ?>InventryStockReceiveController/inventryStockReceiveListwebAPI", // The service URL
