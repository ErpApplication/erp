          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <a class="btn btn-primary pull-right" href="<?php echo base_url(); ?>BooksController/insertBook">Add Book</a>
                <h4 class="card-title">Book List</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tbl_bookList" class="table" style="width:100%">
                    
                    <thead>
                              <tr>
                                <th>Book Number</th>
                                <th>Purchase Account Code</th>
                                <th>Purchase Account Name</th>
                                <th>Sales Account Code</th>
                                <th>Sales Account Name</th>
                                <th>Edit</th>
                              </tr>
                            </thead>
...
$(document).ready(function() {
    ...
    var tbl_bookList = $('#tbl_bookList').DataTable(
      {
      ...
      "processing": false,
              ...
              "scrollX": true,
               ajax: {
                  url: "<?php echo base_url() ?>BooksController/bookListwebAPI", // The service URL
            ...
            "columns": [
            { "data": "book_number"},
            { "data": "purchase_account_code"},
            { "data": "purchase_account_name"},
            { "data": "sales_account_name"},
            { "data": "sales_account_code"},
            { "data": "edit"}
