          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <a class="btn btn-primary pull-right" href="<?php echo base_url(); ?>CashPaymentController/addCashPayment">Add Cash Payment </a>
                <h4 class="card-title">Cash Payment List</h4>
              </div>
              <div class="card-body">
...
$(document).ready(function() {
    ...
    var tbl_cashReceiptList = $('#tbl_cashReceiptList').DataTable(
      ...
      "processing": false,
              ...
              "scrollX": true,
               ajax: {
                  url: "<?php echo base_url() ?>CashPaymentController/cashReceiptListwebAPI", // The service URL
