          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <a class="btn btn-primary pull-right" href="<?php echo base_url(); ?>IssueController/addDispatchMaster">Add Dispatch Master</a>
                <h4 class="card-title">Dispatch Master List</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tbl_salesMasterList" class="table" style="width:100%">
...
$(document).ready(function() {
    ...
    var tbl_salesMasterList = $('#tbl_salesMasterList').DataTable(
      {
      ...
      "processing": false,
              ...
              "scrollX": true,
               ajax: {
                  url: "<?php echo base_url() ?>IssueController/dispatchMasterListwebAPI", // The service URL
