          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <a class="btn btn-primary pull-right" href="<?php echo base_url(); ?>PurchaseController/addPurchase">Add Purchase</a>
...
$(document).ready(function() {
    ...
    var tbl_workMillList = $('#tbl_workMillList').DataTable(
      ...
      "processing": false,
              ...
              "scrollX": true,
               ajax: {
                  url: "<?php echo base_url() ?>PurchaseController/purchaseListwebAPI", // The service URL
