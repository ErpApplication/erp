          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <a class="btn btn-primary pull-right" href="<?php echo base_url(); ?>BankReceiptController/addBankReceipt">Add Bank Receipt</a>
                <h4 class="card-title">Bank Receipt List</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tbl_BankReceiptList" class="table" style="width:100%">
...
$(document).ready(function() {
    ...
    var tbl_BankReceiptList = $('#tbl_BankReceiptList').DataTable(
      {
      ...
      "processing": false,
              ...
              "scrollX": true,
               ajax: {
                  url: "<?php echo base_url() ?>BankReceiptController/bankReceiptListwebAPI", // The service URL
