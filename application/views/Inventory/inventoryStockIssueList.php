          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <a class="btn btn-primary pull-right" href="<?php echo base_url(); ?>InventoryJobIssueController/addStockIssue">Add Inventry Stock Issue</a>
                <h4 class="card-title">Inventory Stock Issue List</h4>
              </div>
              <div class="card-body">
...
$(document).ready(function() {
    ...
    var tbl_receiveWorkMasterList = $('#tbl_receiveWorkMasterList').DataTable(
      ...
      "processing": false,
              ...
              "scrollX": true,
               ajax: {
                  url: "<?php echo base_url() ?>InventoryJobIssueController/inventryStockIssueListwebAPI", // The service URL
