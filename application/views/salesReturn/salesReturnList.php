          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <a class="btn btn-primary pull-right" href="<?php echo base_url(); ?>SalesReturnController/addSalesReturn">Add Sales Return</a>
                <h4 class="card-title">Sales Return List</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tbl_salesReturnList" class="table" style="width:100%">
...
$(document).ready(function() {
    ...
    var tbl_salesReturnList = $('#tbl_salesReturnList').DataTable(
      {
      ...
      "processing": false,
              ...
              "scrollX": true,
               ajax: {
                  url: "<?php echo base_url() ?>SalesReturnController/salesReturnListwebAPI", // The service URL
