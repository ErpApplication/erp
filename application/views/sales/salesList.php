          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <a class="btn btn-primary pull-right" href="<?php echo base_url(); ?>SalesController/addSalesMaster">Add Sales Master</a>
                <h4 class="card-title">Sales Master List</h4>
              </div>
              <div class="card-body">
...
$(document).ready(function() {
    ...
    var tbl_salesMasterList = $('#tbl_salesMasterList').DataTable(
      ...
      "processing": false,
              ...
              "scrollX": true,
               ajax: {
                  url: "<?php echo base_url() ?>SalesController/salesMasterListwebAPI", // The service URL
