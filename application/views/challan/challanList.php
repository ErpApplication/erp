          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <a class="btn btn-primary pull-right" href="<?php echo base_url(); ?>ChallanController/addChallan">Add Challan</a>
                <h4 class="card-title">Challan List</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tbl_challanList" class="table" style="width:100%">
...
$(document).ready(function() {
    ...
    var tbl_challanList = $('#tbl_challanList').DataTable(
      {
      ...
      "processing": false,
              ...
              "scrollX": true,
               ajax: {
                  url: "<?php echo base_url() ?>ChallanController/challanListwebAPI", // The service URL
